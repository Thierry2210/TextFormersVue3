  ...
  <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
    <section class="bg-white p-4 rounded shadow">
      ...
      <div class="space-y-3">
        ...
        <textarea v-model="content" rows="14" placeholder="Escreva aqui..." class="w-full border rounded px-3 py-2"></textarea>
...
import { useEssaysStore, type EssayItem } from '../stores/essays'
...
const feedback = ref<EssayItem['feedback'] | null>(null)
